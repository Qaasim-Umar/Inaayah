      ...
      <main id="main-content">
        <header className="section-space">
          <Container className="text-center">
            ...
            <h1 className="mx-auto mt-5 max-w-3xl text-balance text-4xl font-medium text-brand sm:text-5xl lg:text-6xl">A place to grow.<br /><span className="font-normal">A community to call your own.</span></h1>
